...
import GradientButton from "../gradiant-button";
...
const AutomationList = () => {
  ...
  return (
    <div className="flex flex-col gap-y-3">
      <Link
        href={`${pathname}/121212`}
        className="bg-[#1D1D1D] hover:opacity-80 transition duration-100 rounded-xl p-5 border-[1px] radial--gradient--automations flex border-[#545454]"
      >
        <div className="flex flex-col flex-1 items-start">
          <h2 className="text-xl font-semibold">Automation Name</h2>
          <p className="text-[#989CA0] text-sm font-light mb-2">This is the comment</p>
        ...
        <div className="flex flex-col justify-between">
          <p className="capitalize text-sm font-light text-[#9B9CA0]">October 5th 2024</p>
